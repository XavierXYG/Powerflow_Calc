...
class Wire_Dialog(Dialog):
    def __init__(self, parent=None):
        ...
        self.tf_text = [0, 0, 0, 0, 0, 0]   #type, Dm, diameter, line_distance, length, S_wire

        self.set_button.move(400, 500)
        self.cancel_button.move(500, 500)
